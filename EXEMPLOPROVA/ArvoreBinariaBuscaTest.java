...
public class ArvoreBinariaBuscaTest {
    ...
    public void ancestralComum(){
        ...
        No t1 = arvore.menorAncestral(4, 15);
        assertEquals(10, t1.valor);

        No t2 = arvore.menorAncestral(15, 20);
        assertEquals(20, t2.valor);
        //Se um valor é descendente do outro, o próprio ancestral é o maior deles.
    }
    ...
    public void somaNos(){
        ...
        assertEquals(30, arvore.somaNos());
    }
    ...
    public void verificaBalanceamento(){
        ...
        assertTrue(arvore.verificarBalanceamento());
    }

    @Test
    public void verificaBalancementoF(){
        arvore.adicionar(10);
        arvore.adicionar(20);
        arvore.adicionar(15);
        arvore.adicionar(6);
        ...
        assertFalse(arvore.verificarBalanceamento());
    }
}
