...
public class Vetor {
    ...
    public void adicionar(Cliente novoCliente){
        garantirEspaco();
        clientes[totalDeClientes] = novoCliente; //se tem 3 clientes vai de 0 a 2, mas total = 3.
        totalDeClientes++;
    }
    ...
    public void reduzirMetade(){
        ...
        //garantir que nao reduza menos do que a capacidade inicial
